...
public class BuyCarRecyclerViewDataAdapter extends RecyclerView.Adapter<CarRecyclerViewItemHolder> {

    private List<CarRecyclerViewItem> carItemList;

    public BuyCarRecyclerViewDataAdapter(List<CarRecyclerViewItem> carItemList) {
    ...
    public CarRecyclerViewItemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View carItemView = layoutInflater.inflate(R.layout.buy_view_item, parent, false);
